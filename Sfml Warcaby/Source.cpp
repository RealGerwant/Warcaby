...
int main(int argc, char **argv)
{
	...
	{	
		...
		{
			if (plansza.isKingThatCanToBeat() && !plansza.isPlaceMarkedToMoveFrom())
			{
			...
			{
				if (plansza.IsManThatCanToBeat() && !plansza.isPlaceMarkedToMoveFrom())
				{
			...
			if (!plansza.isKingThatCanToBeat() && !plansza.IsManThatCanToBeat() && !plansza.isPlaceMarkedToMoveFrom())
			{
